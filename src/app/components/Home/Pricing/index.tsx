      ...
      <div className="container">
        <div className="text-center">
          ...
          <p className="text-lg font-normal max-w-lg mx-auto my-6">
            Offering web development, IT support, and technical solutions to help bring your ideas to life.
          </p>
        </div>
        {/* toggle button */}
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
          {/* card-1 */}
          <div className="bg-primary rounded-lg lg:col-span-1 md:col-span-2 min-h-[500px]">
            <div className="flex flex-col justify-between w-full h-full">
              ...
              <div className="flex-1 relative">
                <Image
                  src={getImgPath("/images/Nedit (2).jpeg")}
                  alt="Nedit Xhaferi"
                  fill
